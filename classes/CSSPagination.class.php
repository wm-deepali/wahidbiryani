...
class CSSPagination
{
	...
	public function __construct($db1, $sql, $rowsperpage, $website)
	{
	     $this->db1 = $db1;
		$this->sql = $sql;
	...
	{
		$result = mysqli_query($this->db1,$this->sql) or die ("query failed!");
		// $result = $this->db->query($this->sql)or die ("query failed!");
